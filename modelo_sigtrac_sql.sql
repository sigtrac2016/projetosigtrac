...
-- Schema sigtrac
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sigtrac` DEFAULT CHARACTER SET latin1 ;
USE `sys` ;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_tipo_classe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_tipo_classe` (
  `ctc_id` INT(3) NOT NULL,
  `ctc_descricao` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`ctc_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_tipo_grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_tipo_grupo` (
  `ctg_id` INT(3) NOT NULL,
  `ctc_id` INT(3) NOT NULL,
  `ctg_descricao` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`ctg_id`, `ctc_id`),
  INDEX `fk_crise_tipo_grupo_crise_tipo_classe1_idx` USING BTREE (`ctc_id` ASC),
  CONSTRAINT `crise_tipo_grupo_ibfk_1`
    FOREIGN KEY (`ctc_id`)
    REFERENCES `sigtrac`.`crise_tipo_classe` (`ctc_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_tipo_subgrupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_tipo_subgrupo` (
  `cts_id` INT(3) NOT NULL,
  `ctc_id` INT(3) NOT NULL,
  `cts_descricao` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`cts_id`, `ctc_id`),
  INDEX `fk_subgrupo_tipo_classe_idx` USING BTREE (`ctc_id` ASC),
  CONSTRAINT `crise_tipo_subgrupo_ibfk_1`
    FOREIGN KEY (`ctc_id`)
    REFERENCES `sigtrac`.`crise_tipo_classe` (`ctc_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_tipo` (
  `ctt_id` INT(3) NOT NULL,
  `cts_id` INT(3) NOT NULL,
  `ctg_id` INT(3) NOT NULL,
  `ctc_id` INT(3) NOT NULL,
  `ctt_descricao` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`ctt_id`, `cts_id`, `ctg_id`, `ctc_id`),
  INDEX `fk_crise_tipo_tipo_crise_tipo_subgrupo1_idx` USING BTREE (`cts_id` ASC),
  INDEX `fk_tipo_tipo_grupo_idx` USING BTREE (`ctg_id` ASC),
  INDEX `fk_tipo_tipo_classe_idx` USING BTREE (`ctc_id` ASC),
  CONSTRAINT `crise_tipo_tipo_ibfk_1`
    FOREIGN KEY (`ctc_id`)
    REFERENCES `sigtrac`.`crise_tipo_classe` (`ctc_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_tipo_tipo_ibfk_2`
    FOREIGN KEY (`ctg_id`)
    REFERENCES `sigtrac`.`crise_tipo_grupo` (`ctg_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_tipo_tipo_ibfk_3`
    FOREIGN KEY (`cts_id`)
    REFERENCES `sigtrac`.`crise_tipo_subgrupo` (`cts_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_tipo_subtipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_tipo_subtipo` (
  `ctp_id` INT(3) NOT NULL,
  `ctt_id` INT(3) NOT NULL,
  `cts_id` INT(3) NOT NULL,
  `ctg_id` INT(3) NOT NULL,
  `ctc_id` INT(3) NOT NULL,
  `ctp_descricao` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`ctp_id`, `ctt_id`, `cts_id`, `ctg_id`, `ctc_id`),
  INDEX `fk_crise_tipo_subtipo_crise_tipo_tipo1_idx` USING BTREE (`ctt_id` ASC),
  INDEX `fk_tipo_subtipo_subgrupo_idx` USING BTREE (`cts_id` ASC),
  INDEX `fk_tipo_subtipo_grupo_idx` USING BTREE (`ctg_id` ASC),
  INDEX `fk_tipo_subtipo_classe_idx` USING BTREE (`ctc_id` ASC),
  CONSTRAINT `crise_tipo_subtipo_ibfk_1`
    FOREIGN KEY (`ctc_id`)
    REFERENCES `sigtrac`.`crise_tipo_classe` (`ctc_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_tipo_subtipo_ibfk_2`
    FOREIGN KEY (`ctg_id`)
    REFERENCES `sigtrac`.`crise_tipo_grupo` (`ctg_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_tipo_subtipo_ibfk_3`
    FOREIGN KEY (`cts_id`)
    REFERENCES `sigtrac`.`crise_tipo_subgrupo` (`cts_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_tipo_subtipo_ibfk_4`
    FOREIGN KEY (`ctt_id`)
    REFERENCES `sigtrac`.`crise_tipo` (`ctt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`cidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`cidade` (
  `cid_id` INT(11) NOT NULL AUTO_INCREMENT,
  `cid_nome` VARCHAR(40) CHARACTER SET 'utf8' NOT NULL,
  PRIMARY KEY (`cid_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 5507
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `sigtrac`.`estado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`estado` (
  `est_sigla` CHAR(2) CHARACTER SET 'utf8' NOT NULL,
  `est_nome` VARCHAR(25) CHARACTER SET 'utf8' NOT NULL,
...
-- Table `sigtrac`.`local`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`local` (
  ...
  `estado_est_sigla` CHAR(2) CHARACTER SET 'utf8' NOT NULL,
  PRIMARY KEY (`geo_id`, `cidade_cid_id`, `estado_est_sigla`),
  INDEX `fk_crise_local_cidade1_idx` (`cidade_cid_id` ASC),
  INDEX `fk_crise_local_estado1_idx` (`estado_est_sigla` ASC),
  CONSTRAINT `fk_crise_local_cidade1`
    FOREIGN KEY (`cidade_cid_id`)
    REFERENCES `sigtrac`.`cidade` (`cid_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_crise_local_estado1`
    FOREIGN KEY (`estado_est_sigla`)
    REFERENCES `sigtrac`.`estado` (`est_sigla`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 5566
...
-- Table `sigtrac`.`aviso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`aviso` (
  `avs_id` INT(11) NOT NULL AUTO_INCREMENT,
  `sta_cod` INT(10) UNSIGNED NOT NULL,
  `usu_cod` INT(10) UNSIGNED NOT NULL,
  `avs_ds` VARCHAR(255) NULL DEFAULT NULL,
  `avs_status` VARCHAR(45) NULL,
  PRIMARY KEY (`avs_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `sigtrac`.`crise`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise` (
  `cri_id` INT(11) NOT NULL AUTO_INCREMENT,
  `crt_id` INT(11) NOT NULL,
  `cri_descricao` VARCHAR(60) NOT NULL,
  `cri_inicio` DATE NULL DEFAULT NULL,
  `cri_final` DATE NULL DEFAULT NULL,
  `cri_ativa` BIT(1) NULL DEFAULT NULL,
  `cri_regiao` VARCHAR(250) NULL DEFAULT NULL,
  `cri_geotipo` CHAR(1) NOT NULL COMMENT '1- Coordenadas 2- Cidade 3- Ambas',
  `crise_local_geo_id` INT(11) NOT NULL,
  `aviso_avs_id` INT(11) NOT NULL,
  PRIMARY KEY (`cri_id`),
  INDEX `fk_crise_crise_tipo1_idx` USING BTREE (`crt_id` ASC),
  INDEX `fk_crise_crise_local1_idx` (`crise_local_geo_id` ASC),
  INDEX `fk_crise_aviso1_idx` (`aviso_avs_id` ASC),
  CONSTRAINT `crise_ibfk_1`
    FOREIGN KEY (`crt_id`)
    REFERENCES `sigtrac`.`crise_tipo` (`crt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_crise_crise_local1`
    FOREIGN KEY (`crise_local_geo_id`)
    REFERENCES `sigtrac`.`local` (`geo_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_crise_aviso1`
    FOREIGN KEY (`aviso_avs_id`)
    REFERENCES `sigtrac`.`aviso` (`avs_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 2
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_estacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_estacao` (
  `cre_id` INT(11) NOT NULL AUTO_INCREMENT,
  `cri_id` INT(11) NOT NULL,
  `cre_descricao` VARCHAR(50) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `cre_inicio` DATE NULL DEFAULT NULL,
  `cre_final` DATE NULL DEFAULT NULL,
  `cre_longitude` DOUBLE NULL DEFAULT NULL,
  `cre_latitude` DOUBLE NULL DEFAULT NULL,
  `cre_regiao` VARCHAR(100) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  PRIMARY KEY (`cre_id`),
  INDEX `fk_crise_estacao_crise1_idx` (`cri_id` ASC),
  CONSTRAINT `fk_crise_estacao_crise1`
    FOREIGN KEY (`cri_id`)
    REFERENCES `sigtrac`.`crise` (`cri_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 6
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_sensor_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_sensor_tipo` (
  `cst_id` INT(11) NOT NULL AUTO_INCREMENT,
  `cst_nome` VARCHAR(50) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `cst_descricao` VARCHAR(150) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  PRIMARY KEY (`cst_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 12
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_sensor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_sensor` (
  `cse_id` INT(11) NOT NULL AUTO_INCREMENT,
  `cst_id` INT(11) NOT NULL,
  `cre_id` INT(11) NOT NULL,
  `cse_descricao` VARCHAR(50) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `cse_faixaini` FLOAT NULL DEFAULT NULL,
  `cse_faixafim` FLOAT NULL DEFAULT NULL,
  `cse_alerta` FLOAT NULL DEFAULT NULL,
  `cse_critico` FLOAT NULL DEFAULT NULL,
  PRIMARY KEY (`cse_id`, `cst_id`, `cre_id`),
  INDEX `fk_crise_sensor_crise_sensor_tipo1_idx` (`cst_id` ASC),
  INDEX `fk_crise_sensor_crise_estacao1_idx` (`cre_id` ASC),
  CONSTRAINT `fk_crise_sensor_crise_estacao1`
    FOREIGN KEY (`cre_id`)
    REFERENCES `sigtrac`.`crise_estacao` (`cre_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_crise_sensor_crise_sensor_tipo1`
    FOREIGN KEY (`cst_id`)
    REFERENCES `sigtrac`.`crise_sensor_tipo` (`cst_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 26
...
-- -----------------------------------------------------
-- Table `sigtrac`.`alerta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`alerta` (
  `alt_id` INT(11) NOT NULL AUTO_INCREMENT,
  `geo_cod` INT(10) UNSIGNED NOT NULL,
  `cri_cod` INT(10) UNSIGNED NOT NULL,
  `alt_msg` VARCHAR(255) NULL DEFAULT NULL,
  `alt_raio` FLOAT NOT NULL,
  `alt_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `crise_sensor_cse_id` INT(11) NOT NULL,
  `crise_sensor_cst_id` INT(11) NOT NULL,
  `crise_sensor_cre_id` INT(11) NOT NULL,
  PRIMARY KEY (`alt_id`),
  INDEX `fk_alerta_crise_sensor1_idx` (`crise_sensor_cse_id` ASC, `crise_sensor_cst_id` ASC, `crise_sensor_cre_id` ASC),
  CONSTRAINT `fk_alerta_crise_sensor1`
    FOREIGN KEY (`crise_sensor_cse_id` , `crise_sensor_cst_id` , `crise_sensor_cre_id`)
    REFERENCES `sigtrac`.`crise_sensor` (`cse_id` , `cst_id` , `cre_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `sigtrac`.`api`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`api` (
  `api_id` INT(11) NOT NULL AUTO_INCREMENT,
  `api_nome` VARCHAR(45) NOT NULL,
  `api_ativa` BIT(1) NULL DEFAULT NULL,
  `api_url` VARCHAR(100) NULL DEFAULT NULL,
  PRIMARY KEY (`api_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`categoria` (
  `cat_id` INT(11) NOT NULL AUTO_INCREMENT,
  `crt_cod` INT(10) UNSIGNED NOT NULL,
  `cat_ds` VARCHAR(150) NULL DEFAULT NULL,
  PRIMARY KEY (`cat_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 32
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_api`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_api` (
  `cap_id` INT(11) NOT NULL AUTO_INCREMENT,
  `cri_id` INT(11) NOT NULL,
  `api_id` INT(11) NOT NULL,
  `cap_inicio` DATE NULL DEFAULT NULL,
  `cap_final` DATE NULL DEFAULT NULL,
  `cap_ativa` BIT(1) NULL DEFAULT NULL,
  `cap_key` VARCHAR(50) NULL DEFAULT NULL,
  `cap_secret` VARCHAR(50) NULL DEFAULT NULL,
  `cap_token` VARCHAR(100) NULL DEFAULT NULL,
  `cap_token_secret` VARCHAR(100) NULL DEFAULT NULL,
  PRIMARY KEY (`cap_id`),
  INDEX `fk_crise_has_api_api1_idx` USING BTREE (`api_id` ASC),
  INDEX `fk_crise_has_api_crise1_idx` USING BTREE (`cri_id` ASC),
  CONSTRAINT `crise_api_ibfk_1`
    FOREIGN KEY (`api_id`)
    REFERENCES `sigtrac`.`api` (`api_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `crise_api_ibfk_2`
    FOREIGN KEY (`cri_id`)
    REFERENCES `sigtrac`.`crise` (`cri_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sigtrac`.`crise_identificacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_identificacao` (
  `cii_id` INT(11) NOT NULL AUTO_INCREMENT,
  `crt_id` INT(11) NOT NULL,
  `pal_id` INT(11) NOT NULL,
  `cii_tipo` CHAR(1) NOT NULL COMMENT 'I - Identificação\nT- Tempo\nS - Sentimento',
  `cii_sentimento` CHAR(1) NULL DEFAULT NULL COMMENT 'P - Positivo\nN - Negativo\nO - Não se aplica',
  `cii_tempo` CHAR(1) NULL DEFAULT NULL,
  PRIMARY KEY (`cii_id`),
  INDEX `fk_crise_identificacao_crise_tipo1_idx` USING BTREE (`crt_id` ASC),
  CONSTRAINT `crise_identificacao_ibfk_2`
    FOREIGN KEY (`crt_id`)
    REFERENCES `sigtrac`.`crise_tipo` (`crt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sigtrac`.`central_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`central_tipo` (
  `idcentral_tipo` INT NOT NULL,
  `tipo` VARCHAR(45) NULL,
  PRIMARY KEY (`idcentral_tipo`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sigtrac`.`central`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`central` (
  `idcentral` INT NOT NULL,
  `local_geo_id` INT(11) NOT NULL,
  `local_cidade_cid_id` INT(11) NOT NULL,
  `local_estado_est_sigla` CHAR(2) CHARACTER SET 'utf8' NOT NULL,
  `CNPJ` VARCHAR(45) NULL,
  `qtde_veiculos` INT NULL,
  `workforce` INT NULL,
  `central_tipo_idcentral_tipo` INT NOT NULL,
  `numero_de_cadastro` INT NOT NULL,
  PRIMARY KEY (`idcentral`, `central_tipo_idcentral_tipo`),
  INDEX `fk_central_local1_idx` (`local_geo_id` ASC, `local_cidade_cid_id` ASC, `local_estado_est_sigla` ASC),
  INDEX `fk_central_central_tipo1_idx` (`central_tipo_idcentral_tipo` ASC),
  CONSTRAINT `fk_central_local1`
    FOREIGN KEY (`local_geo_id` , `local_cidade_cid_id` , `local_estado_est_sigla`)
    REFERENCES `sigtrac`.`local` (`geo_id` , `cidade_cid_id` , `estado_est_sigla`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_central_central_tipo1`
    FOREIGN KEY (`central_tipo_idcentral_tipo`)
    REFERENCES `sigtrac`.`central_tipo` (`idcentral_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`usuario` (
  `usu_id` INT(11) NOT NULL AUTO_INCREMENT,
  `usu_nm` CHAR(50) NOT NULL,
  `usu_pwd` CHAR(20) NOT NULL,
  `usu_email` CHAR(100) NOT NULL,
  `usu_fone` CHAR(20) NOT NULL,
  `usu_app` BIT(1) NOT NULL,
  `usu_ultimo_login` DATETIME NOT NULL,
  `api_api_id` INT(11) NOT NULL,
  `central_idcentral` INT NOT NULL,
  `central_central_tipo_idcentral_tipo` INT NOT NULL,
  PRIMARY KEY (`usu_id`),
  INDEX `fk_usuario_api1_idx` (`api_api_id` ASC),
  INDEX `fk_usuario_central1_idx` (`central_idcentral` ASC, `central_central_tipo_idcentral_tipo` ASC),
  CONSTRAINT `fk_usuario_api1`
    FOREIGN KEY (`api_api_id`)
    REFERENCES `sigtrac`.`api` (`api_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_central1`
    FOREIGN KEY (`central_idcentral` , `central_central_tipo_idcentral_tipo`)
    REFERENCES `sigtrac`.`central` (`idcentral` , `central_tipo_idcentral_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 3
...
-- -----------------------------------------------------
-- Table `sigtrac`.`alerta_has_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`alerta_has_usuario` (
  `alerta_alt_id` INT(11) NOT NULL,
  `usuario_usu_id` INT(11) NOT NULL,
  PRIMARY KEY (`alerta_alt_id`, `usuario_usu_id`),
  INDEX `fk_alerta_has_usuario_usuario1_idx` (`usuario_usu_id` ASC),
  INDEX `fk_alerta_has_usuario_alerta1_idx` (`alerta_alt_id` ASC),
  CONSTRAINT `fk_alerta_has_usuario_alerta1`
    FOREIGN KEY (`alerta_alt_id`)
    REFERENCES `sigtrac`.`alerta` (`alt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_alerta_has_usuario_usuario1`
    FOREIGN KEY (`usuario_usu_id`)
    REFERENCES `sigtrac`.`usuario` (`usu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`aviso_has_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`aviso_has_usuario` (
  `aviso_avs_id` INT(11) NOT NULL,
  `usuario_usu_id` INT(11) NOT NULL,
  PRIMARY KEY (`aviso_avs_id`, `usuario_usu_id`),
  INDEX `fk_aviso_has_usuario_usuario1_idx` (`usuario_usu_id` ASC),
  INDEX `fk_aviso_has_usuario_aviso1_idx` (`aviso_avs_id` ASC),
  CONSTRAINT `fk_aviso_has_usuario_aviso1`
    FOREIGN KEY (`aviso_avs_id`)
    REFERENCES `sigtrac`.`aviso` (`avs_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aviso_has_usuario_usuario1`
    FOREIGN KEY (`usuario_usu_id`)
    REFERENCES `sigtrac`.`usuario` (`usu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sigtrac`.`UTI CRAMP PRIORIDADE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`UTI CRAMP PRIORIDADE` (
  `idUTI CRAMP` INT NOT NULL,
  `cor` VARCHAR(45) NULL,
  `pontuacao` VARCHAR(45) NULL,
  `descrição` VARCHAR(45) NULL,
  PRIMARY KEY (`idUTI CRAMP`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sigtrac`.`UTI CRAMP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`UTI CRAMP` (
  `idUTI CRAMP` INT NOT NULL,
  `pontuação total` INT NOT NULL,
  `Circulação` INT NULL,
  `Respiração Tórax` INT NULL,
  `Abdomen` INT NULL,
  `Motor` INT NULL,
  `Palavra` VARCHAR(45) NULL,
  `UTI CRAMP PRIORIDADE_idUTI CRAMP` INT NOT NULL,
  PRIMARY KEY (`idUTI CRAMP`, `pontuação total`, `UTI CRAMP PRIORIDADE_idUTI CRAMP`),
  INDEX `fk_UTI CRAMP_UTI CRAMP PRIORIDADE1_idx` (`UTI CRAMP PRIORIDADE_idUTI CRAMP` ASC),
  CONSTRAINT `fk_UTI CRAMP_UTI CRAMP PRIORIDADE1`
    FOREIGN KEY (`UTI CRAMP PRIORIDADE_idUTI CRAMP`)
    REFERENCES `sigtrac`.`UTI CRAMP PRIORIDADE` (`idUTI CRAMP`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`vitima`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`vitima` (
  `idvitima` INT NOT NULL,
  `fone` VARCHAR(12) NULL,
  `estado civil` VARCHAR(10) NULL,
  `nome` VARCHAR(45) NULL,
  `rg` VARCHAR(45) NULL,
  `cpf` VARCHAR(45) NULL,
  `UTI CRAMP_idUTI CRAMP` INT NOT NULL,
  `UTI CRAMP_pontuação total` INT NOT NULL,
  PRIMARY KEY (`idvitima`),
  INDEX `fk_vitima_UTI CRAMP1_idx` (`UTI CRAMP_idUTI CRAMP` ASC, `UTI CRAMP_pontuação total` ASC),
  CONSTRAINT `fk_vitima_UTI CRAMP1`
    FOREIGN KEY (`UTI CRAMP_idUTI CRAMP` , `UTI CRAMP_pontuação total`)
    REFERENCES `sigtrac`.`UTI CRAMP` (`idUTI CRAMP` , `pontuação total`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`tipo_veículo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`tipo_veículo` (
  `idtipoveículo` INT NOT NULL,
  `descrição` VARCHAR(45) NULL,
  PRIMARY KEY (`idtipoveículo`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sigtrac`.`crise_has_veículo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`crise_has_veículo` (
  `crise_cri_id` INT(11) NOT NULL,
  `veículo_idveículo` INT NOT NULL,
  PRIMARY KEY (`crise_cri_id`, `veículo_idveículo`),
  INDEX `fk_crise_has_veículo_veículo1_idx` (`veículo_idveículo` ASC),
  INDEX `fk_crise_has_veículo_crise1_idx` (`crise_cri_id` ASC),
  CONSTRAINT `fk_crise_has_veículo_crise1`
    FOREIGN KEY (`crise_cri_id`)
    REFERENCES `sigtrac`.`crise` (`cri_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_crise_has_veículo_veículo1`
    FOREIGN KEY (`veículo_idveículo`)
    REFERENCES `sigtrac`.`tipo_veículo` (`idtipoveículo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`veículo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`veículo` (
  `idveículo` INT NOT NULL,
  `tipo_veículo_idtipoveículo` INT NOT NULL,
  `equipamentos` VARCHAR(45) NULL,
  `placa` VARCHAR(7) NOT NULL,
  `central_idcentral` INT NOT NULL,
  PRIMARY KEY (`idveículo`, `tipo_veículo_idtipoveículo`, `placa`),
  INDEX `fk_veículo_tipo_veículo1_idx` (`tipo_veículo_idtipoveículo` ASC),
  INDEX `fk_veículo_central1_idx` (`central_idcentral` ASC),
  CONSTRAINT `fk_veículo_tipo_veículo1`
    FOREIGN KEY (`tipo_veículo_idtipoveículo`)
    REFERENCES `sigtrac`.`tipo_veículo` (`idtipoveículo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_veículo_central1`
    FOREIGN KEY (`central_idcentral`)
    REFERENCES `sigtrac`.`central` (`idcentral`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigtrac`.`equipamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`equipamento` (
...
-- -----------------------------------------------------
-- Table `sigtrac`.`veículo_has_equipamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigtrac`.`veículo_has_equipamento` (
  `veículo_idveículo` INT NOT NULL,
  `veículo_tipo_veículo_idtipoveículo` INT NOT NULL,
  `veículo_placa` VARCHAR(7) NOT NULL,
  `equipamento_idequipamento` INT NOT NULL,
  PRIMARY KEY (`veículo_idveículo`, `veículo_tipo_veículo_idtipoveículo`, `veículo_placa`, `equipamento_idequipamento`),
  INDEX `fk_veículo_has_equipamento_equipamento1_idx` (`equipamento_idequipamento` ASC),
  INDEX `fk_veículo_has_equipamento_veículo1_idx` (`veículo_idveículo` ASC, `veículo_tipo_veículo_idtipoveículo` ASC, `veículo_placa` ASC),
  CONSTRAINT `fk_veículo_has_equipamento_veículo1`
    FOREIGN KEY (`veículo_idveículo` , `veículo_tipo_veículo_idtipoveículo` , `veículo_placa`)
    REFERENCES `sigtrac`.`veículo` (`idveículo` , `tipo_veículo_idtipoveículo` , `placa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_veículo_has_equipamento_equipamento1`
    FOREIGN KEY (`equipamento_idequipamento`)
    REFERENCES `sigtrac`.`equipamento` (`idequipamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
