...
var RC522 = function(uuid, timestamp, value, location) {
  this.uuid = uuid
...
sensors.forEach(function(entry) {
  var value = new Value(random(90000000000, 99999999999))
  var location = new Location(entry[1], entry[2], entry[3])
  var sensor = new RC522(entry[0], timestamp, value, location)
