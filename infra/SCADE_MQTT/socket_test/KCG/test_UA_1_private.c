...
/* Widget Label for parameter A661_POS_XY */
 uaa_size a661_com_msg_structure_0(buffer_el msg[], 
  uaa_uint16 pid,  uaa_int32 A661_POS_XY_PosY_,  uaa_int32 A661_POS_XY_PosX_){
  WRITE_USHORT(msg, pid);
  WRITE_USHORT(msg + 2, 0);
  WRITE_ULONG(msg + 4, A661_POS_XY_PosX_);
  WRITE_ULONG(msg + 8, A661_POS_XY_PosY_);
  return 12 ;
}

/* Pack messages for widget Label: A661_POS_XY */
 uaa_size a661_com_csp_widget_Label(buffer_el msg[], 
  uaa_uint16 wid,  uaa_bool A661_POS_XY__emit__,  uaa_int32 A661_POS_XY_PosX_, 
  uaa_int32 A661_POS_XY_PosY_){
  uaa_size offset = 0;
  if (A661_POS_XY__emit__){
    offset = 8;
    a661_msg_csp_header(msg, wid);
    if (A661_POS_XY__emit__){
      offset = offset + a661_com_msg_structure_0(msg + offset, A661_POS_XY,
        A661_POS_XY_PosY_, A661_POS_XY_PosX_);
    }
