...
"C:\Program Files\Esterel Technologies\SCADE R17\SCADE Display\bin\ScadeDisplayConsole.exe" batch generate "C:\Users\SHIGEMURA-PC\TS08-Drone\TS08-Drone.etp" -conf "DF Generation" -source "UADF.sgfx" -outdir "C:/Users/SHIGEMURA-PC/TS08-Drone/TS08-Drone/Simulation" -prefix "Main_UA_1"
@IF ERRORLEVEL 1 GOTO failed
@move "Main_UA_1.log" "Main_UA_1_dfgen.log"
"C:\Program Files\Esterel Technologies\SCADE R17\SCADE Display\bin\ScadeDisplayConsole.exe" batch  generateServerConf "C:\Users\SHIGEMURA-PC\TS08-Drone\TS08-Drone.etp" -spec "UADF.sgfx" -out "C:/Users/SHIGEMURA-PC/TS08-Drone/TS08-Drone/Simulation/Main_UA_1_conf.xml"
@exit 0
:failed
@exit 1
