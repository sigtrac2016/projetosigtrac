...
/* Widget PushButton for parameter A661_STRING */
 uaa_size a661_com_msg_structure_0(buffer_el msg[], 
  uaa_uint16 pid,  kcg_int A661_STRING_String_size_, 
...
/* Widget Label for parameter A661_COLOR_INDEX */
 uaa_size a661_com_msg_char(buffer_el msg[], 
  uaa_uint16 pid,  kcg_int A661_COLOR_INDEX_ColorIndex_){
  WRITE_USHORT(msg, pid);
...
/* Generate message with generic function a661_com_msg_float */
/* Widget NumericReadout for parameter A661_VALUE */
 uaa_size a661_com_msg_float(buffer_el msg[], 
  uaa_uint16 pid,  uaa_float32 A661_VALUE_Value_){
  WRITE_USHORT(msg, pid);
...
/* Generate message with generic function a661_com_msg_structure_1 */
/* Widget Symbol for parameter A661_ORIENTATION */
 uaa_size a661_com_msg_structure_1(buffer_el msg[], 
  uaa_uint16 pid,  uaa_float32 A661_ORIENTATION_RotationAngle_){
  WRITE_USHORT(msg, pid);
  WRITE_USHORT(msg + 2, 0);
  write_fr32_with_real(msg + 4, A661_ORIENTATION_RotationAngle_, 180);
  return 8 ;
}

/* Pack messages for widget Symbol: A661_ORIENTATION */
 uaa_size a661_com_csp_widget_Symbol(buffer_el msg[], 
  uaa_uint16 wid,  uaa_bool A661_ORIENTATION__emit__, 
  uaa_float32 A661_ORIENTATION_RotationAngle_){
  uaa_size offset = 0;
  if (A661_ORIENTATION__emit__){
    offset = 8;
    a661_msg_csp_header(msg, wid);
    if (A661_ORIENTATION__emit__){
      offset = offset + a661_com_msg_structure_1(msg + offset, A661_ORIENTATION,
        A661_ORIENTATION_RotationAngle_);
    }
...
/* Pack messages for widget PushButton: A661_STRING */
 uaa_size a661_com_csp_widget_PushButton(buffer_el msg[], 
  ...
  unsigned innerdim_A661_STRING_LabelString_, 
  unsigned char * A661_STRING_LabelString_,  kcg_int A661_STRING_String_size_){
  uaa_size offset = 0;
...
/* Pack messages for widget NumericReadout: A661_VALUE */
 uaa_size a661_com_csp_widget_NumericReadout(buffer_el msg[], 
  uaa_uint16 wid,  uaa_bool A661_VALUE__emit__,  uaa_float32 A661_VALUE_Value_){
  uaa_size offset = 0;
  if (A661_VALUE__emit__){
    offset = 8;
    a661_msg_csp_header(msg, wid);
    if (A661_VALUE__emit__){
      offset = offset + a661_com_msg_float(msg + offset, A661_VALUE,
        A661_VALUE_Value_);
    }
    WRITE_USHORT(msg + 2, offset);
  }
...
/* Pack messages for widget Label: A661_COLOR_INDEX, A661_STRING */
 uaa_size a661_com_csp_widget_Label(buffer_el msg[], 
  ...
  kcg_int A661_COLOR_INDEX_ColorIndex_,  uaa_bool A661_STRING__emit__, 
  unsigned innerdim_A661_STRING_LabelString_, 
  unsigned char * A661_STRING_LabelString_,  kcg_int A661_STRING_String_size_){
  uaa_size offset = 0;
  if (A661_STRING__emit__ ||
