...
const char* _SCSIM_CheckSum = "44c24aad02581381d92a2e281e026eca";
 ...
 *******************************/
inC_test inputs_ctx;
static inC_test inputs_ctx_restore;
static inC_test inputs_ctx_execute;
...
static void _SCSIM_RestoreInterface(void) {
    ...
    inputs_ctx.Notification = inputs_ctx_restore.Notification;
    inputs_ctx.SignalFromButton = inputs_ctx_restore.SignalFromButton;
    inputs_ctx.Title = inputs_ctx_restore.Title;
    inputs_ctx.Latitude = inputs_ctx_restore.Latitude;
    inputs_ctx.Longitude = inputs_ctx_restore.Longitude;
    inputs_ctx.Status = inputs_ctx_restore.Status;
    inputs_ctx.NotifyFromOcurrenceType = inputs_ctx_restore.NotifyFromOcurrenceType;
...
static void _SCSIM_ExecuteInterface(void) {
    ...
    inputs_ctx_execute.Notification = inputs_ctx.Notification;
    inputs_ctx_execute.SignalFromButton = inputs_ctx.SignalFromButton;
    inputs_ctx_execute.Title = inputs_ctx.Title;
    inputs_ctx_execute.Latitude = inputs_ctx.Latitude;
    inputs_ctx_execute.Longitude = inputs_ctx.Longitude;
    inputs_ctx_execute.Status = inputs_ctx.Status;
    inputs_ctx_execute.NotifyFromOcurrenceType = inputs_ctx.NotifyFromOcurrenceType;
...
int SimStep(void) {
    ...
    test(&inputs_ctx_execute, &outputs_ctx);
#ifdef EXTENDED_SIM
    AfterSimStep();
#endif /* EXTENDED_SIM */
    return 1;
...
void SsmGatherDumpData(char * pData) {
    char* pCurrent = pData;
    memcpy(pCurrent, &inputs_ctx, sizeof(inC_test));
    pCurrent += sizeof(inC_test);
...
void SsmRestoreDumpData(const char * pData) {
    ...
    memcpy(&inputs_ctx, pCurrent, sizeof(inC_test));
    pCurrent += sizeof(inC_test);
