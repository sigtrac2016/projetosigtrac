...
uaa_size a661_com_csp_widget_SelectionListButton(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_OPENING_ENTRY__emit__, kcg_int A661_OPENING_ENTRY_OpeningEntry_);
